 ...
 */class ie{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(a=>{if(oe(a)){const r=a.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(a=>a).join(" ")}}function oe(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const I="@firebase/app",P="0.15.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c=new W("@firebase/app"),ce="@firebase/app-compat",de="@firebase/analytics-compat",he="@firebase/analytics",fe="@firebase/app-check-compat",pe="@firebase/app-check",le="@firebase/auth",me="@firebase/auth-compat",ue="@firebase/database",be="@firebase/data-connect",ge="@firebase/database-compat",we="@firebase/functions",De="@firebase/functions-compat",_e="@firebase/installations",Ee="@firebase/installations-compat",ye="@firebase/messaging",Ie="@firebase/messaging-compat",Ce="@firebase/performance",Se="@firebase/performance-compat",ve="@firebase/remote-config",$e="@firebase/remote-config-compat",Be="@firebase/storage",Ae="@firebase/storage-compat",xe="@firebase/firestore",Me="@firebase/ai",Pe="@firebase/firestore-compat",Ne="firebase",Te="12.16.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C="[DEFAULT]",Fe={[I]:"fire-core",[ce]:"fire-core-compat",[he]:"fire-analytics",[de]:"fire-analytics-compat",[pe]:"fire-app-check",[fe]:"fire-app-check-compat",[le]:"fire-auth",[me]:"fire-auth-compat",[ue]:"fire-rtdb",[be]:"fire-data-connect",[ge]:"fire-rtdb-compat",[we]:"fire-fn",[De]:"fire-fn-compat",[_e]:"fire-iid",[Ee]:"fire-iid-compat",[ye]:"fire-fcm",[Ie]:"fire-fcm-compat",[Ce]:"fire-perf",[Se]:"fire-perf-compat",[ve]:"fire-rc",[$e]:"fire-rc-compat",[Be]:"fire-gcs",[Ae]:"fire-gcs-compat",[xe]:"fire-fst",[Pe]:"fire-fst-compat",[Me]:"fire-vertex","fire-js":"fire-js",[Ne]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b=new Map,He=new Map,S=new Map;function N(e,t){try{e.container.addComponent(t)}catch(a){c.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,a)}}function v(e){const t=e.name;if(S.has(t))return c.debug(`There were multiple attempts to register component ${t}.`),!1;S.set(t,e);for(const a of b.values())N(a,e);for(const a of He.values())N(a,e);return!0}function qe(e,t){const a=e.container.getProvider("heartbeat").getImmediate({optional:!0});return a&&a.triggerHeartbeat(),e.container.getProvider(t)}function et(e){return e==null?!1:e.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tt=Te;function Oe(e,t={}){let a=e;typeof t!="object"&&(t={name:t});const r={name:C,automaticDataCollectionEnabled:!0,...t},n=r.name;if(typeof n!="string"||!n)throw f.create("bad-app-name",{appName:String(n)});if(a||(a=L()),!a)throw f.create("no-options");const s=b.get(n);if(s){if(B(a,s.options)&&B(r,s.config))return s;throw f.create("duplicate-app",{appName:n})}const i=new K(n);for(const o of S.values())i.addComponent(o);const d=new Re(a,r,i);return b.set(n,d),d}function at(e=C){const t=b.get(e);if(!t&&e===C&&L())return Oe();if(!t)throw f.create("no-app",{appName:e});return t}function m(e,t,a){let r=Fe[e]??e;a&&(r+=`-${a}`);const n=r.match(/\s|\//),s=t.match(/\s|\//);if(n||s){const i=[`Unable to register library "${r}" with version "${t}":`];n&&i.push(`library name "${r}" contains illegal characters (whitespace or "/")`),n&&s&&i.push("and"),s&&i.push(`version name "${t}" contains illegal characters (whitespace or "/")`),c.warn(i.join(" "));return}v(new u(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke="firebase-heartbeat-database",je=1,l="firebase-heartbeat-store";let _=null;function U(){return _||(_=re(ke,je,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(l)}catch(a){console.warn(a)}}}}).catch(e=>{throw f.create("idb-open",{originalErrorMessage:e.message})})),_}async function Ue(e){try{const a=(await U()).transaction(l),r=await a.objectStore(l).get(V(e));return await a.done,r}catch(t){if(t instanceof O)c.warn(t.message);else{const a=f.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});c.warn(a.message)}}}async function T(e,t){try{const r=(await U()).transaction(l,"readwrite");await r.objectStore(l).put(t,V(e)),await r.done}catch(a){if(a instanceof O)c.warn(a.message);else{const r=f.create("idb-set",{originalErrorMessage:a==null?void 0:a.message});c.warn(r.message)}}}function V(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ye(e){v(new u("platform-logger",t=>new ie(t),"PRIVATE")),v(new u("heartbeat",t=>new Ge(t),"PRIVATE")),m(I,P,e),m(I,P,"esm2020"),m("fire-js","")}Ye("");var Xe="firebase",Qe="12.16.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */m(Xe,Qe,"app");export{tt as S,v as _,et as a,qe as b,at as g,Oe as i,m as r};
